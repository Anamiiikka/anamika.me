      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-[#0f0f0f]/80 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 md:px-12 h-20 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
            ...
            <a href="https://drive.google.com/file/d/1kGNE1t6zV6-c-n79ov37Wfp0iMiuK5B4/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-[#E2F84E] transition-colors">
